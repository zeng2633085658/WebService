 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://service.ws.com/", wsdlLocation = "http://127.0.0.1:9900/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://service.ws.com/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:9900/hello?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://service.ws.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ws.com/", "HelloServicePort"), HelloService.class, features);
    }
